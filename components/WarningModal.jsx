...
import warningAnimation from "../lottieAnimations/warningAnimation.json";
import { RxCross2 } from "react-icons/rx";

const WarningModal = ({ animation, message, setIsWarning }) => {
  const defaultOptions = {
    // loop: true,
    autoplay: true,
    animationData: animation || warningAnimation,
    rendererSettings: {
